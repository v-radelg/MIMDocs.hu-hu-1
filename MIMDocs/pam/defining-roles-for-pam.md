...
- [Az emelt szintű hozzáférés védelme – referenciaanyag](https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material)
