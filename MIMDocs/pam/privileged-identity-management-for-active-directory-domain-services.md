---
title: "Privileged Access Management az Active Directory tartományi szolgáltatásokhoz | Microsoft Identity Manager"
description: 
keywords: 
author: kgremban
manager: femila
...
A Privileged Access Management (PAM) megoldás a Microsoft Identity Manager (MIM), a Windows Server 2012 R2 és a Windows Server Technical Preview alapjaira épül. Segít a szervezeteknek abban, hogy meglévő Active Directory-környezetükben korlátozzák a rendszerjogosultságú hozzáférést.
