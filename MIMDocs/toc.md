...
## [Gyakorlati tanácsok](mim-best-practices.md)
...
## [Üzembe helyezés TLS 1.2 vagy FIPS módú környezetekben](preparing-tls.md)
## [Első üzembe helyezés](microsoft-identity-manager-deploy.md)
### [Tartomány beállítása](preparing-domain.md)
### [Tartomány beállítása GMSA-hoz](preparing-domain-gmsa.md)
### [Kiszolgáló beállítása: Windows Server](prepare-server-ws2016.md)
### [Kiszolgáló beállítása: SQL](prepare-server-sql2016.md)
...
## [Frissítés a MIM 2016 SP2-re](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
...
## [A Graph-összekötő konfigurálása B2B-hez](microsoft-identity-manager-2016-graph-b2b-scenario.md)
## [Az Azure MFA-kiszolgáló használata a PAM-ban vagy az SSPR-ben](working-with-mfaserver-for-mim.md)
## [Egyéni MFA-szolgáltató használata a PAM-ban vagy az SSPR-ben](working-with-custommfaserver-for-mim.md)
...
## [Az ajánlott eljárásokat elemző modul](https://technet.microsoft.com/library/jj203402)
...
### [Általános SQL-útmutató lépésről lépésre](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
