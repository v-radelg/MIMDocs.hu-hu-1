...
5.  Jobb gombbal kattintson a **Felhasználói sablonra**, majd kattintson a **Sablon duplikálása** parancsra..
...
6.  A **Kompatibilitás** lapon a Hitelesítésszolgáltató területen válassza a Windows Server 2008 lehetőséget, majd a Tanúsítvány kedvezményezettje területen válassza a Windows 8.1 / Windows Server 2012 R2 beállítást.
    ...
    5.  A **Tulajdonos neve** lapon
        ...
        1.  Törölje **Az e-mail név belefoglalása a tulajdonosnévbe** beállítás jelölését..
...
8.  Jelölje be a **Generate encryption keys on the server** (Titkosítási kulcsok generálása a kiszolgálón) elemtől balra lévő négyzeteket, majd kattintson az **OK** gombra. A bal oldali panelen kattintson a **Recover Policy** (Helyreállítási irányelv) elemre..
